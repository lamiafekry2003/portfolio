  ...
  <div>
      ...
      >
        ...
        <div className="text-center my-4">
          <a to="#" className="text-2xl font-extrabold font-serif">
            Jackson Ford
          </a>
          <p className="pt-2 text-neutral-600 text-sm">
            <span className="text-blue-500">UI/UX/Designer</span> in Philippines
          </p>
        </div>
